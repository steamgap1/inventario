...
export function renderProducts(products, userRole, getProductRow) {
    ...
    const table = `
        ...
        <table class="table table-hover table-sm">
            ...
            <tbody>
                ${products.map(p => getProductRow(p, userRole)).join('')}
            </tbody>
        </table>
    `;
    appView.innerHTML = table;
}

export function renderWarranties(warranties) {
    const searchFilterForm = `
        <div class="mb-3 p-3 border rounded bg-light">
...
export function renderProviders(providers, userRole, getProviderRow) {
    const actionsHeader = (userRole === 'admin') ? '<th>Acciones</th>' : '';
    const searchFilterForm = `
        <div class="mb-3 p-3 border rounded bg-light">
    ...
    const table = `
        ...
        <table class="table table-hover table-sm">
            ...
            <tbody>
                ${providers.map(p => getProviderRow(p, userRole)).join('')}
            </tbody>
        </table>
    `;
    appView.innerHTML = table;
...
export function renderSales(sales, userRole) {
    const searchFilterForm = `
        <div class="mb-3 p-3 border rounded bg-light">
...
export function renderReports(reportType, reportData) {
...
export function showWarrantyForm(products, warranty = {}) {
...
export function showSaleForm(products) {
...
export function showAlert(message, type = 'success') {
    ...
    appView.prepend(alertPlaceholder);
    setTimeout(() => {
